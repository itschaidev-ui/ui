...
export function OAuthForm({
  ...
  return (
    <StyledWrapper>
      <form className="ui-oauth-form" onSubmit={handleSubmit}>
        <p>
          {title}
          <span>{subtitle}</span>
        </p>
        ...
        {showGoogle ? (
          <button type="button" className="oauthButton" onClick={onGoogleClick}>
        ...
        {showGithub ? (
          <button type="button" className="oauthButton" onClick={onGithubClick}>
            <svg className="icon" viewBox="0 0 24 24" aria-hidden="true">
