    ...
    <StyledWrapper>
      <button type="button" className="button" onClick={onClick}>
        ...
        <div className="state state--default">
          ...
          <p>
            {defaultChars.map((char, index) => (
              <span key={`default-${index}`} style={{ "--i": index } as CSSProperties}>
                {char}
              </span>
            ))}
          </p>
        ...
        <div className="state state--sent">
          ...
          <p>
            {sentChars.map((char, index) => (
              <span key={`sent-${index}`} style={{ "--i": index + 5 } as CSSProperties}>
                {char}
              </span>
            ))}
          </p>
